  ...
  const connect = (url: string, connection: Connection) => {
    ...
    ws.onmessage = (event) => {
      ...
      if (json) {
        ...
        setNotifications(e => [{...json, address: connection.address, secure: connection.secure, notificationConnection: connection}, ...e])
      }
    }
    ws.onclose = (e) => {
        ...
        openModal && selectedNotification?.type === 'pipeline-error' &&
          <Modal onClose={() => handleCloseModal()} open={openModal} title={''}
              ...
              <ShardComponent
                  ...
                  notificationConnection={selectedNotification.notificationConnection}
